    ...
    return (
      <div className="min-h-[80vh] bg-[#F8FAFC] flex flex-col justify-center items-center p-6">
        <div className="max-w-md w-full bg-white rounded-[40px] shadow-2xl p-10 text-center border border-gray-100 relative overflow-hidden">
          ...
          <div className="absolute -top-20 -right-20 w-40 h-40 bg-blue-100 rounded-full blur-3xl opacity-60"></div>
          <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-yellow-100 rounded-full blur-3xl opacity-60"></div>

          <div className="relative z-10">
            {/* Ikon Gembok */}
            <div className="w-24 h-24 bg-gradient-to-tr from-blue-600 to-indigo-600 text-white rounded-full flex items-center justify-center text-4xl mx-auto mb-6 shadow-lg shadow-blue-200">
              <FaLock />
            </div>
            
            <h2 className="text-3xl font-black text-gray-900 mb-3 tracking-tight">Konten Eksklusif</h2>
            <p className="text-gray-600 mb-8 leading-relaxed text-sm">
              Halaman ini khusus untuk member <span className="font-bold text-blue-600">SMART PAI DIGITAL</span>. Silakan masuk atau daftar akun secara gratis untuk mengakses materi, jurnal, dan fitur premium lainnya.
            </p>
