...
const Founder = () => {
  return (
    <div className="bg-slate-50 min-h-screen pb-16 font-sans">
      ...
      <div className="bg-blue-700 text-white pt-8 pb-32 px-6 relative overflow-hidden">
        {/* Dekorasi Background */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="text-left mb-6">
            <Link to="/" className="text-sm text-blue-200 hover:text-white inline-flex items-center gap-2 transition-colors">
      ...
      <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl -mt-20 p-8 md:p-12 relative z-20 mx-4 lg:mx-auto">
        ...
        <div className="mt-16 pt-8 border-t border-slate-100 text-center">
          <a 
            ...
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
          >
